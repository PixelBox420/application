...
##timeout_valuex = 2000  # 300 seconds = 5 minutes
app = Flask(__name__)
##app.config['TIMEOUT'] = timeout_valuex  # Set timeout to 300 seconds (adjust as needed)
...
second_server_url = "http://[REDACTED]:5000/submit_studenthousing"  # Update with the correct URL of the second server
...
def signup():
    ...
    if not re.match(r'^[a-zA-Z0-9_.@]+$', emailx):
        # Invalid email format
        emailx = 'empty1'
        passwordx = 'empty2'
        
    # Validate password format
    if not re.match(r'^[a-zA-Z0-9]+$', passwordx):
   ...
   #### print(f"Email: {emailx}, Password: hidden")
    # Your existing logic to retrieve form data
    #firstname = request.form.get('firstname')
    # ... (all other form fields)
...
def run_app():
   ...
   #### print(filex)
    ...
    templatepress2 = request.form.get('templatepress2')
    templatepress3 = request.form.get('templatepress3')
    templatepress4 = request.form.get('templatepress4')
    desired_start_date = request.form.get('desired_start_date')
   ...
   #### print('templatepressvalues:', templatepress2,"-",templatepress3,"-",templatepress4)
   #### print(desired_start_date)
    ...
    data = {
        ...
        'templatepress2': templatepress2,
        'templatepress3': templatepress3,
        'templatepress4': templatepress4,
   ...
   #### print(files)
    ...
    try:
       ...
       #### print("Error connecting to the backend server, please contact administrator:", e)
